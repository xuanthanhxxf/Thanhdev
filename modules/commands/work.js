...
if (handleReply.author != event.senderID) return api.sendMessage("Bố cái loại không làm đòi có ăn !\nBot said : Không làm đòi có ăn thì ăn đầu buồi ăn cứt !", event.threadID, event.messageID)
//random coins nhận được khi làm việc ít nhất 100000
var coinscn = Math.floor(Math.random() * 800000) + 1000000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 950000) + 1000000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 700000) + 1000000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 750000) + 1000000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 750000) + 1000000 //random coins khi đào đá
var coinscsdv = Math.floor(Math.random() * 700000) + 1000000; //random coins khi chăm sóc động vật
