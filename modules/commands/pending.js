...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
  ...
  const picture = (await axios.get(`https://i.imgur.com/vcKuCFI.gif`, { responseType: "stream"})).data
