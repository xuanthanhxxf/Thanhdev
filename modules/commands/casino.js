...
module.exports.run = async function ({ api, event, args, Currencies, Users }) {//const permission = ["uid1","uid2"];
//if (!permission.includes(event.senderID)) return api.sendMessage("Key bạn đã hết lượt Request vui lòng mua key mới ", event.threadID, event.messageID);
